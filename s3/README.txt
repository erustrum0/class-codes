...
p4.cpp and p7.cpp are more complex than the others. p4.cpp uses a library called "getch.h" for letting the user input a character without needing
    ...
    the program. p4simple.cpp removes the "getch.h" dependency but can only determine if a character is a vowel or not (for code size considerations).
    The p7.cpp program uses a mapped array (I think people just call them maps) to associate numbers with the names of months. p7simple.cpp uses a
